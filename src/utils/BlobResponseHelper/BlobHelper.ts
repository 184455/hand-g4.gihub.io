...
class BlobHelper {
   ...
   * @returns {BlobHelper}
   */
  static fromBase64(base64: string, mimetype: string): BlobHelper {
   ...
   * @returns {BlobHelper}
   */
  static fromBlob(blob: Blob): BlobHelper {
   ...
   * @param mimetype MIME类型
   */
  static fromText(text: string, mimetype = 'text/plain') {
  ...
  private _arrayBuffer?: Promise<ArrayBuffer>;
  private _blob: Promise<Blob>;
  private _dataURL?: Promise<string>;
  private _json?: any;
  private _objectURL?: Promise<string>;
